...
<html lang="en">
<head>
    <title>Code coverage report for components/DataTable/DataTable.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/DataTable</a> DataTable.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (targetTagName === 'td' || targetTagName === 'tr') {
...
&nbsp;
		...
		const flattenedColumns = _.reduce(
			...
			(acc, childComponentElement) =&gt; {
				...
				<span class="missing-if-branch" title="else path not taken" >E</span>if (childComponentElement.type === DataTable.ColumnGroup) {
					return acc.concat(
						_.map(
			...
			&gt;
				...
				&gt;
					&lt;Thead&gt;
						&lt;Tr&gt;
							{isSelectable ? (
								&lt;Th rowSpan={hasGroupedColumns ? <span class="branch-0 cbranch-no" title="branch not covered" >2 </span>: null} width={24}&gt;
									&lt;Checkbox
								...
								({ props, type }, index) =&gt;
									type === DataTable.Column ? (
										...
										&lt;Th
											...
											key={_.get(props, 'field', index)}
										&gt;
											{props.title || <span class="branch-1 cbranch-no" title="branch not covered" >props.children}</span>
										&lt;/Th&gt;
									)
							)}
						&lt;/Tr&gt;
