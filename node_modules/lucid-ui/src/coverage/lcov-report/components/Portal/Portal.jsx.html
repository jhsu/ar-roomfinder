...
<html lang="en">
<head>
    <title>Code coverage report for components/Portal/Portal.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/Portal</a> Portal.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (!portalElement) {
