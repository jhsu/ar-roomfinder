...
<html lang="en">
<head>
    <title>Code coverage report for components/SlidePanel/SlidePanel.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/SlidePanel</a> SlidePanel.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
		<span class="missing-if-branch" title="else path not taken" >E</span>if (slidesSwiped !== 0) {
...
&nbsp;
	componentDidMount() {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.isLooped) {
...
&nbsp;
	componentDidUpdate(prevProps, prevState) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if (offsetDiff !== 0) {
			<span class="missing-if-branch" title="else path not taken" >E</span>if (this.props.isLooped) {
...
&nbsp;
		return (
			&lt;div
				...
				ref={<span class="fstat-no" title="function not covered" >do</span>mNode =&gt; {
<span class="cstat-no" title="statement not covered" >					this.rootNode = domNode;</span>
				}}
			...
			&gt;
				...
				&gt;
					{<span class="fstat-no" title="function not covered" >tw</span>een =&gt; (
<span class="cstat-no" title="statement not covered" >						&lt;div</span>
						...
						&gt;
							{_.map(slides, <span class="fstat-no" title="function not covered" >(s</span>lide, offset) =&gt; (
<span class="cstat-no" title="statement not covered" >								&lt;div</span>
									key={offset}
									{...slide.props}
