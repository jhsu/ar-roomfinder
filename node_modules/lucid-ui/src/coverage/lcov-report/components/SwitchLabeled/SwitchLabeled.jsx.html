...
<html lang="en">
<head>
    <title>Code coverage report for components/SwitchLabeled/SwitchLabeled.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/SwitchLabeled</a> SwitchLabeled.jsx
    </h1>
    <div class='clearfix'>
...
&nbsp;
	componentWillReceiveProps(nextProps) {
		const currentLabel = <span class="cstat-no" title="statement not covered" >_.get(</span>
			getFirst(this.props, SwitchLabeled.Label),
			'props.children',
			null
		);
		const nextLabel = <span class="cstat-no" title="statement not covered" >_.get(</span>
			getFirst(nextProps, SwitchLabeled.Label),
			'props.children',
			null
		);
&nbsp;
<span class="cstat-no" title="statement not covered" >		if (currentLabel !== nextLabel) {</span>
<span class="cstat-no" title="statement not covered" >			this._labelKey++;</span>
		}
	},
&nbsp;
	render() {
				...
				&gt;
					{labelChildProps ? (
						&lt;span key={this._labelKey}&gt;
							{labelChildProps.children || <span class="branch-1 cbranch-no" title="branch not covered" >labelChildProps}</span>
						&lt;/span&gt;
					) : null}
				&lt;/ReactTransitionGroup&gt;
			&lt;/label&gt;
