...
<html lang="en">
<head>
    <title>Code coverage report for components/DropMenu/DropMenu.reducers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">components/DropMenu</a> DropMenu.reducers.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
	if (_.isNull(focusedIndex)) {
		nextFocusedIndex = 0;
	} else <span class="missing-if-branch" title="else path not taken" >E</span>if (_.isNumber(focusedIndex)) {
