...
function common(Component) {
	...
	describe('[common]', function () {
		...
		it('should pass through styles to the root element', function () {
			...
			var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(Component, _extends({}, generateDefaultProps(), { style: style })), { disableLifecycleMethods: true });
		...
		it('should pass through `className`', function () {
			...
			var wrapper = (0, _enzyme.shallow)(_react2.default.createElement(Component, _extends({}, generateDefaultProps(), { className: expectedClass })), { disableLifecycleMethods: true });
			var rootWrapper = selectRoot(wrapper).first();
		...
		describe('child components', function () {
			...
			var childComponents = (0, _pickBy3.default)(Component, function (value, key) {
				return (/^[A-Z]/.test(key) && (0, _isFunction3.default)(value)
				);
			});
			...
			(0, _each3.default)(fileNames, function (path) {
				...
				it('should match snapshot(s) for ' + title, function () {
					...
					if (shallowExample.is(Component.displayName)) {
						expect((0, _enzyme.shallow)(_react2.default.createElement(Component, shallowExample.props()), {
							disableLifecycleMethods: true
						})).toMatchSnapshot();
					} else {
						shallowExample.find(Component.displayName).forEach(function (example) {
							expect((0, _enzyme.shallow)(_react2.default.createElement(Component, example.props()), {
								disableLifecycleMethods: true
							})).toMatchSnapshot();
						});
					}
